...
exports.default = {
  ...
  methods: {
    resetFields: function resetFields() {
      if (!this.model) {
        "production" !== 'production' && console.warn('[Element Warn][Form]entity is required for resetFields to work.');
        return;
      }
    ...
    validate: function validate(callback) {
      ...
      if (!this.model) {
        console.warn('[Element Warn][Form]entity is required for validate to work!');
        return;
      }
